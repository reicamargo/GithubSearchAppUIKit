...
class GFAlertViewController: UIViewController {
    ...
    let tittleLabel = GFTitleLabel(textAlignment: .center, fontSize: 20)
    ...
    func configureTitleLabel() {
        containerView.addSubview(tittleLabel)
        
        tittleLabel.text = alertTitle ?? "Something went wrong"
    ...
    func configureMessageLabel() {
        ...
        NSLayoutConstraint.activate([
            messageLabel.topAnchor.constraint(equalTo: tittleLabel.bottomAnchor, constant: 8),
